                        ...
                        <div class="row  pt-5" >
                            <div class="col-md-8 shadow rounded offset-md-2 col-sm-10 offset-sm-1 bg-white pt-4" >
                                ...
                                <div class="row">
                                    ...
                                    <span class="font-weight-bold"></span> The seminar hall that you have booked for the event  (ie., <span class="text-warning"> Event Name '.$eventname.' Date - '.$date.'  </span>) has been successfully. 
                                    <br> 
                                    </p>
                                    <hr>
                                    </div>
